...
resource "aws_security_group" "ec2_sec_ports" {
    name = "ec2_sec_ports"
...
resource "aws_instance" "site_deploy" {
    ...
    security_groups = [aws_security_group.ec2_sec_ports.name]
    ...
    provisioner "remote-exec" {
        inline = ["sudo apt update",
            ...
            "git clone https://github.com/kamuridesu/kamublog.git && cd kamublog",
